...
let c2=document.querySelector('.cart_button');
let cart_c=document.querySelector('.cart-container');
let close=document.getElementById('close');

c2.addEventListener('click',sideWayCart);
c.addEventListener('click',sideWayCart);
function sideWayCart()
{
    cart_c.classList.toggle('active');
}


close.addEventListener('click',inactivate);
function inactivate()
{
    cart_c.classList.remove('active');
};
